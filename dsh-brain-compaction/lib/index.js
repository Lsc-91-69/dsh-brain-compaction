...
var BRAIN_NAMESPACE = settingsNamespace("brain-compaction");
...
function verifyReport(ctx, session, detail) {
  ...
  const engineCheck = {
    ok: engine.id !== null,
    text: engine.id ? `PASS  \u538B\u7F29\u5F15\u64CE ctx.compaction = ${engine.className}\uFF08\u2192 ${engine.id}\uFF09` : "FAIL  \u672A\u53D1\u73B0 ctx.compaction \u538B\u7F29\u5F15\u64CE\uFF1A\u8BF7\u68C0\u67E5 profile \u7EC4\u5408\uFF08compaction-basic \u5FC5\u987B\u88AB\u7981\u7528\u4E14\u4EC5\u4E00\u4E2A\u5F15\u64CE\u884C\u542F\u7528\uFF09"
  };
  const guidance = [
